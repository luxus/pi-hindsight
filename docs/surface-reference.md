...
| `projectRetainMission`       | Banks      | text         | built-in default                     |                                           | yes      | banks.project.retainMission        | Advanced. Overrides what project retain extracts. Built-in default: Extract durable project memory from raw Pi coding sessions: architecture decisions, constraints, bugs, fixes, TODOs, repo conventions, and project-local user preferences. Ignore transient chatter, secrets, and resurfaced recalled memories unless they add a new correction or decision. |
| `projectReflectMission`      | Banks      | text         | built-in default                     |                                           | yes      | banks.project.reflectMission       | Advanced. Overrides how project reflect uses memories. Built-in default: Help a Pi coding agent recall project-specific architecture, engineering decisions, conventions, tasks, bugs, fixes, constraints, and continuity.                                                                                                                                       |
| `projectObservationsMission` | Banks      | text         | built-in default                     |                                           | yes      | banks.project.observationsMission  | Advanced. Overrides what project observation consolidation synthesizes. Built-in default: Identify durable project patterns, recurring constraints, architectural preferences, and contradictions across Pi coding sessions. Focus on stable repo-relevant knowledge, not transient task state.                                                                  |
...
| `globalRetainMission`        | Banks      | text         | built-in default                     |                                           | yes      | banks.global.retainMission         | Advanced. Overrides what global retain extracts. Built-in default: Extract durable cross-project memory from raw Pi sessions: user preferences, recurring workflows, coding habits, and stable assistant behavior. Do not retain repo-specific code facts, file paths, project-local bugs, or transcript dumps unless they generalize across projects.           |
| `globalReflectMission`       | Banks      | text         | built-in default                     |                                           | yes      | banks.global.reflectMission        | Advanced. Overrides how global reflect uses memories. Built-in default: Help a Pi coding agent recall durable cross-project user preferences, recurring workflows, coding habits, and stable assistant behavior guidance.                                                                                                                                        |
| `globalObservationsMission`  | Banks      | text         | built-in default                     |                                           | yes      | banks.global.observationsMission   | Advanced. Overrides what global observation consolidation synthesizes. Built-in default: Identify durable cross-project user preferences, recurring workflows, coding habits, and stable assistant behavior patterns. Ignore repo-specific implementation details unless they generalize across projects.                                                        |
