...
- [ADR 004: lifeOS dual-bank design](./adr/004-lifeos-dual-bank-design/)
- [ADR 005: Domain banks and agent-first surface](./adr/005-domain-banks-and-agent-first-surface/)
